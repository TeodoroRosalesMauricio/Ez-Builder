<%-- 
    Document   : G_gprod
    Created on : 21 may. 2022, 13:52:57
    Author     : Mauricio
--%>
        ...
        <div class="listado_prod">
            <%
                ...
                try {
                    ...
                    String strQry1 = "select producto.id_prod,nom_prod,prec_prod,img_prod,gabinete.forma_case,mbocomp_case,psu_case,id_case,stock_prod from producto "
                            + "inner join gabinete on producto.id_prod = gabinete.id_prod " 
                            + "inner join vendedorprod on vendedorprod.id_prod = producto.id_prod "
                            + "inner join vendedor on vendedor.id_ven = vendedorprod.id_ven "
                            + "where vendedor.id_ven = '"+id+"' ;";
                    ResultSet rs1 = null;
                    rs1 = bd.consulta(strQry1);
                    
                    String strQry2 = "select producto.id_prod,nom_prod,prec_prod,img_prod,cooler.ruido_cooler,socket_cooler,nfan_cooler,id_cooler,stock_prod from producto "
                    ...
                    String strQry3 = "select producto.id_prod,nom_prod,prec_prod,img_prod,procesador.nucl_cpu,graph_cpu,frecbase_cpu,id_cpu,stock_prod from producto "
                    ...
                    String strQry4 = "select producto.id_prod,nom_prod,prec_prod,img_prod,tar_grafica.memoria_gpu,tipomem_gpu,fboost,id_gpu,stock_prod from producto "
                    ...
                    String strQry5 = "select producto.id_prod,nom_prod,prec_prod,img_prod,hdd.cap_hdd,vel_hdd,interf_hdd,id_hdd,stock_prod from producto "
                    ...
                    String strQry6 = "select producto.id_prod,nom_prod,prec_prod,img_prod,laptop.cpu_laptop,ram_laptop,disk_laptop,id_laptop,stock_prod from producto "
                    ...
                    String strQry7 = "select producto.id_prod,nom_prod,prec_prod,img_prod,mobo.chipset_mobo,socket_mobo,maxram_mobo,id_mobo,stock_prod from producto "
                    ...
                    String strQry8 = "select producto.id_prod,nom_prod,prec_prod,img_prod,pc.cpu_pc,ram_pc,disk_pc,id_pc,stock_prod from producto "
                    ...
                    String strQry9 = "select producto.id_prod,nom_prod,prec_prod,img_prod,fuentepoder.potencia_psu,plus80_psu,forma_psu,id_psu,stock_prod from producto "
                    ...
                    String strQry10 = "select producto.id_prod,nom_prod,prec_prod,img_prod,ram.tam_ram,tipo_ram,vel_ram,id_ram,stock_prod from producto "
                    ...
                    String strQry11 = "select producto.id_prod,nom_prod,prec_prod,img_prod,ssd.cap_ssd,vlec_ssd,vesc_ssd,id_ssd,stock_prod from producto "
                    ...
                    <table class="tablap">
                        ...
                        <tr>
                            ...
                            <td class="botonyprecio" rowspan="3">
                                ...
                                <div class="basurita1">
                                    <div class="basurita">
                                        <a href="G_prod_borrar_A.jsp?idprod=<%=idprod%>">
