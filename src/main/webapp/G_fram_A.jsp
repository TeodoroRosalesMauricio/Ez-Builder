<%-- 
    Document   : G_fram_A
    Created on : 23 may. 2022, 16:53:27
    Author     : usuario1
--%>
...
<html>
    ...
    <%
        ...
        <%
            ...
            if (!marca.equals("") && !linea.equals("") && !tipo.equals("") 
                    && !tam.equals("") && !vel.equals("") && !cas.equals("")
                    && !modulos.equals("") && !rgb.equals("")) {
                ...
                try {
                    ...
                    String strQry1 = "insert into ram (marca_ram, linea_ram, tipo_ram, tam_ram, vel_ram, cas_ram, modulo_ram, rgb_ram, id_prod )"
                                + "values('"+marca+"' , '"+linea+"' , '"+tipo+"' , '"+tam+"' , '"+vel+"' , '"+cas+"' , '"+modulos+"' , '"+rgb+"' , '"+idprod+"' );";
