        ...
        <div id="fondo_negro_faqs">
            ...
            <div id="contenido_x2">
                ...
                <div id="boton3">
                    ...
                    <a href="asesor_faq_editar.jsp?id_fak=<%=id_fak%>">  <button id="boton_rep">Editar</button> </a><br> <br> <br> <br> 
                    <a href="asesor_del_faq.jsp?id_fak=<%=id_fak%>">  <button id="boton_rep">Eliminar FAQ</button> </a> <br> <br> <br> <br> 
