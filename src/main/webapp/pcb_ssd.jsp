<%-- 
    Document   : pcb_ssd
    Created on : 27 mar. 2022, 14:35:33
    Author     : Mauricio
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            int idhdd = Integer.parseInt(request.getParameter("idhdd"));
            ...
            try{
                ...
                String strQry2 = "update pc_builder set id_hdd = '"+idhdd+"' "
        ...
        <div class="divseleccion">
            ...
            <%
                ...
                try {
                    bd.conectar();
                    String strQry = "select id_ssd,img_prod,nom_prod,cap_ssd,interf_ssd,vlec_ssd,vesc_ssd,prec_prod from producto "
                            + "inner join ssd on producto.id_prod = ssd.id_prod order by prec_prod asc;";
                    ResultSet rs = null;
                    ...
                    while (rs.next()) {
                        idssd = Integer.parseInt(rs.getString(1));
            %>
                    ...
                    <div class="info_prod">
                        ...
                        <div class="detalles">
                            ...
                            <br>
                            Almacenamiento: <b><%=rs.getString(4)%></b><br>
                            Interfaz: <b><%=rs.getString(5)%></b><br> 
                            Vel. de lectura: <b><%=rs.getString(6)%></b><br>
                            Vel. de escritura: <b><%=rs.getString(7)%></b> 
                        </div>
                        <div class="presio">
                            <br>
                            Precio:
                            ...
                            <a href="pcb_psu.jsp?idssd=<%=idssd%>">
