...
<html>
    ...
    <body>
        ...
        <%
            ...
            try {
                bd.conectar();
                String strQry = "select producto.*,ram.* from producto "
                        + "inner join ram on producto.id_prod = ram.id_prod "
                        + "where ram.id_prod = '" + idprod + "' ;";
                ResultSet rs = null;
            ...
            <div class="derecho">
                ...
                <div class="info">
                    ...
                    <div class="caracteristicas">
                        ...
                        <div class="texto_car">
                            Memoria: <b><%=rs.getString(17)%></b><br>

                            Velocidad máxima: <b><%=rs.getString(16)%></b><br>

                            Tipo de memoria: <b><%=rs.getString(15)%></b>
