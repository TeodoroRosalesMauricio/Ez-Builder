...
<html>
    ...
    <body>
        <%
            ...
            try {
                bd.conectar();
                String strQry = "select producto.*,gabinete.* from producto "
            ...
            <div class="dropdown2">
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        ...
                        <a href="GestionP_ven.jsp">Gestion de productos</a>
            ...
            <div class="derecho">
                ...
                <div class="info">
                    ...
                    <div class="caracteristicas">
                        ...
                        <div class="texto_car">
                            <!-- Características -->
                            Factor de forma: <b><%=rs.getString(15)%></b><br>

                            Motherboards soportadas: <b><%=rs.getString(16)%></b><br>

                            Fuente de poder: <b><%=rs.getString(24)%></b>
            ...
            <div class="abajo">
                ...
                <div class="tabla">
                    ...
                    <table class="tablat">
                        ...
                        <tr class="fila2">
                            <td>&nbsp;
                                Ventiladores del gabinete soportados:
                            </td>
                            <td>
                                <%=rs.getString(20)%>
                            </td>
                        ...
                        <tr class="fila1">
                            <td>&nbsp;
                                Ranuras de expansión del gabinete:
                            </td>
                            <td>
                                <%=rs.getString(21)%>
                            </td>
                        ...
                        <tr class="fila2">
                            <td>&nbsp;
                                Altura máxima del procesador + disipador:
                            </td>
                            <td>
                                <%=rs.getString(22)%>
                            </td>
                        ...
                        <tr class="fila2">
                            <td>&nbsp;
                                Factor de forma de la fuente de poder y ubicación:
                            </td>
                            <td>
                                <%=rs.getString(24)%>
                            </td>
