        ...
        <div id="fondo_negro">
            ...
            <div id="contenido_x">
                ...
                <div id="derecho">
                    ...
                    <label class="label_rep" id="ing_sopa_R"><b><%=rs2.getString(20)%></b></label>
                    <label class="label_rep" id="IDing_sopa_R"> <b><%=rs2.getString(9)%></b></label>
                </div>


                <div id="boton">
                    
                    <a href="asesor_new_faq.jsp?id_rep=<%=id_rep%>">  <button id="boton_rep">Generar FAQ</button> </a> 
