<%-- 
    Document   : A_inicio_mtto
    Created on : 19 abr. 2022, 14:55:12
    Author     : Mauricio
--%>
    ...
    <body>
        <%
            ...
            if (!usuario.equals("0") && !usuario.equals("0")) {
                ...
                try {
                    bd.conectar();
                    String strQry = "select * from ing_mtto where user_mtto = '"+usuario+"' and pass_mtto = '"+contra+"' ;";
                    ...
                    if (rs.next()) {
                        ...
                        int id = rs.getInt("id_ingmt");
                        miSessiondelUsuario.setAttribute("id", id);
                        response.sendRedirect("mtto.jsp");
                    } else {
        %>
        ...
        <div style="height: 450px; width: 40%;" class="contenedor">
            ...
            <div class="contenedorIn">
                ...
                <!-- Formulario -->
                <form action="A_inicio_mtto.jsp" method="post" name="f1">
