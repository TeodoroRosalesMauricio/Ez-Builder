<%-- 
    Document   : pcb_psu
    Created on : 27 mar. 2022, 14:35:49
    Author     : Mauricio
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            int idssd = Integer.parseInt(request.getParameter("idssd"));
            ...
            try{
                ...
                String strQry2 = "update pc_builder set id_ssd = '"+idssd+"' "
        ...
        <div class="divseleccion">
            <div class="seleccionar">
                ...
                <div class="instruccion">
                    <div class="imginstruccion">
                        <img src="iconos\pws.png" alt="psu" />
                    </div>
                    <div class="instruccionletras">       
                            9. Elige la fuente de poder             
                    </div>
                </div>
            ...
            <%
                ...
                try {
                    bd.conectar();
                    String strQry = "select id_psu,img_prod,nom_prod,potencia_psu,plus80_psu,forma_psu,prec_prod from producto "
                            + "inner join fuentepoder on producto.id_prod = fuentepoder.id_prod order by prec_prod asc;";
                    ResultSet rs = null;
                    ...
                    while (rs.next()) {
                        idpsu = Integer.parseInt(rs.getString(1));
            %>
                    ...
                    <div class="info_prod">
                        ...
                        <div class="detalles">
                            ...
                            <br>
                            Potencia: <b><%=rs.getString(4)%></b><br>
                            Certificación 80 PLUS: <b><%=rs.getString(5)%></b><br> 
                            Factor de forma: <b><%=rs.getString(6)%></b>                           
                        </div>
                        <div class="presio">
                            <br>
                            Precio:
                            ...
                            <a href="pcb_case.jsp?idpsu=<%=idpsu%>">
