<%-- 
    Document   : busqueda
    Created on : 14 may. 2022, 14:39:48
    Author     : Mauricio
--%>
                    ...
                    <table class="tablap">
                        ...
                        <tr>
                            ...
                            <td class="botonyprecio" rowspan="3">
                                ...
                                <a href="vista_case.jsp?idprod=<%=idprod%>">
                                    <input type="button" id="ver" class="carritob" value="Ver producto">
                                </a>
                            </td>
                        </tr>
                    ...
                    <table class="tablap">
                        ...
                        <tr>
                            ...
                            <td class="botonyprecio" rowspan="3">
                                ...
                                <br>
                                <input type="button" id="ver" class="carritob" value="Ver producto">
                                <a href="vista_cooler.jsp?idprod=<%=idprod%>">
                                    <input type="button" id="ver" class="carritob" value="Ver producto">
                                </a>
                            </td>
                        </tr>
                    ...
                    <table class="tablap">
                        ...
                        <tr>
                            ...
                            <td class="botonyprecio" rowspan="3">
                                ...
                                <br>
                                <input type="button" id="ver" class="carritob" value="Ver producto">
                                <a href="vista_cpu.jsp?idprod=<%=idprod%>">
                                    <input type="button" id="ver" class="carritob" value="Ver producto">
                                </a>
                            </td>
                        </tr>
                    ...
                    <table class="tablap">
                        ...
                        <tr>
                            ...
                            <td class="botonyprecio" rowspan="3">
                                ...
                                <br>
                                <input type="button" id="ver" class="carritob" value="Ver producto">
                                <a href="vista_gpu.jsp?idprod=<%=idprod%>">
                                    <input type="button" id="ver" class="carritob" value="Ver producto">
                                </a>
                            </td>
                        </tr>
                    ...
                    <table class="tablap">
                        ...
                        <tr>
                            ...
                            <td class="botonyprecio" rowspan="3">
                                ...
                                <br>
                                <input type="button" id="ver" class="carritob" value="Ver producto">
                                <a href="vista_hdd.jsp?idprod=<%=idprod%>">
                                    <input type="button" id="ver" class="carritob" value="Ver producto">
                                </a>
                            </td>
                        </tr>
                    ...
                    <table class="tablap">
                        ...
                        <tr>
                            ...
                            <td class="botonyprecio" rowspan="3">
                                ...
                                <br>
                                <input type="button" id="ver" class="carritob" value="Ver producto">
                                <a href="vista_laptop.jsp?idprod=<%=idprod%>">
                                    <input type="button" id="ver" class="carritob" value="Ver producto">
                                </a>
                            </td>
                        </tr>
                    ...
                    <table class="tablap">
                        ...
                        <tr>
                            ...
                            <td class="botonyprecio" rowspan="3">
                                ...
                                <br>
                                <input type="button" id="ver" class="carritob" value="Ver producto">
                                <a href="vista_mobo.jsp?idprod=<%=idprod%>">
                                    <input type="button" id="ver" class="carritob" value="Ver producto">
                                </a>
                            </td>
                        </tr>
                    ...
                    <table class="tablap">
                        ...
                        <tr>
                            ...
                            <td class="botonyprecio" rowspan="3">
                                ...
                                <br>
                                <input type="button" id="ver" class="carritob" value="Ver producto">
                                <a href="vista_pc.jsp?idprod=<%=idprod%>">
                                    <input type="button" id="ver" class="carritob" value="Ver producto">
                                </a>
                            </td>
                        </tr>
                    ...
                    <table class="tablap">
                        ...
                        <tr>
                            ...
                            <td class="botonyprecio" rowspan="3">
                                ...
                                <br>
                                <input type="button" id="ver" class="carritob" value="Ver producto">
                                <a href="vista_psu.jsp?idprod=<%=idprod%>">
                                    <input type="button" id="ver" class="carritob" value="Ver producto">
                                </a>
                            </td>
                        </tr>
                    ...
                    <table class="tablap">
                        ...
                        <tr>
                            ...
                            <td class="botonyprecio" rowspan="3">
                                ...
                                <br>
                                <input type="button" id="ver" class="carritob" value="Ver producto">
                                <a href="vista_ssd.jsp?idprod=<%=idprod%>">
                                    <input type="button" id="ver" class="carritob" value="Ver producto">
                                </a>
                            </td>
                        </tr>
