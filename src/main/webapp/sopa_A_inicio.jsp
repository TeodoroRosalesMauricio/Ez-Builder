<%-- 
    Document   : sopa_A_inicio
    Created on : 21 abr. 2022, 03:23:56
    Author     : usuario1
--%>
    ...
    <body>
        <%
            ...
            if (!usuario.equals("0") && !usuario.equals("0")) {
                ...
                try {
                    bd.conectar();
                    String strQry = "select * from ing_sopa where user_sopa = '" + usuario + "' and pass_sopa = '" + contra + "' ;";
                    ...
                    if (rs.next()) {
                        ...
                        int id = rs.getInt("id_sopa");
                        miSessiondelUsuario.setAttribute("id", id);
                        response.sendRedirect("sopa_main.jsp");
                    } else {
        %>
