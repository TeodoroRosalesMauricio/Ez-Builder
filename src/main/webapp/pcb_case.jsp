<%-- 
    Document   : pcb_case
    Created on : 27 mar. 2022, 14:36:01
    Author     : Mauricio
--%>
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>PC-Builder Gabinete</title>
    ...
    <body>
        ...
        <%
            ...
            int idpsu = Integer.parseInt(request.getParameter("idpsu"));
            ...
            try{
                ...
                String strQry2 = "update pc_builder set id_psu = '"+idpsu+"' "
        ...
        <div class="divseleccion">
            ...
            <%
                ...
                try {
                    bd.conectar();
                    String strQry = "select id_case,img_prod,nom_prod,forma_case,mbocomp_case,prec_prod from producto "
                            + "inner join gabinete on producto.id_prod = gabinete.id_prod order by prec_prod asc;";
                    ResultSet rs = null;
                    ...
                    while (rs.next()) {
                        idcase = Integer.parseInt(rs.getString(1));
            %>
                    ...
                    <div class="info_prod">
                        ...
                        <div class="detalles">
                            ...
                            Tarjetas madre soportdas: <b><%=rs.getString(5)%></b><br>                         
                        </div>
                        <div class="presio">
                            <br>
                            Precio:
                            ...
                            <a href="pcb_nombre.jsp?idcase=<%=idcase%>">
