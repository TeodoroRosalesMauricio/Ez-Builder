...
<html>
    ...
    <body>
        ...
        <div id="banner_x_faq">
            ...
            <label id="txt_banner_faq">Nueva FAQ</label>

        </div>

        <div id="fondo_negro_faqs">

            <form action="asesor_faq_noeven.jsp" method="post" name="formulario1">
                ...
                <div id="contenido_x2">
                    ...
                    <div id="derecho">
                        <textarea class="label_rep" name="pregunta" id="descripcion_R" placeholder="Escribe la pregunta" required maxlength="1500"></textarea>
                        <textarea class="label_rep" name="respuesta" id="descripcion_R" placeholder="Escribe la respuesta" required maxlength="1500"></textarea>
                    </div>


                    <div id="boton3">

                        <a href="asesor_faq_noeven.jsp"> <button name="id_faq" value="" type="submit" id="boton_rep">Generar FAQ</button> </a> <br> <br> <br> <br> 
                        <a href="asesor_faqs_main.jsp">  <button id="boton_rep">Regresar</button> </a>  
