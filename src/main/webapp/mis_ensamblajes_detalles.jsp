<%-- 
    Document   : mis_ensamblajes_detalles
    Created on : 21 may. 2022, 15:17:54
    Author     : usuario1
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            String idbuild = request.getParameter("id_build");
        ...
        <div class="divproductosdos">
            ...
            <%
                try {
                    ...
                    String strQry1 = "select img_prod,nom_prod,nucl_cpu,graph_cpu,frecbase_cpu,producto.prec_prod,producto.id_prod from procesador "
                    ...
                    rs1.next();
                    idprod1 = Integer.parseInt(rs1.getString(7));
            %>
                    <div class="info_prod">
                        <a href="vista_cpu_cli.jsp?idprod=<%=idprod1%>">
            ...
            <%
                ...
                if(iddelcooler == 1){
                    ...
                    String strQry2 = "select img_prod,nom_prod,socket_cooler,producto.prec_prod,producto.id_prod from cooler "
                            + "inner join pc_builder on cooler.id_cooler = pc_builder.id_cooler "
                    ...
                    rs2.next();
                    idprod2 = Integer.parseInt(rs2.getString(5));
            %>
                    <div class="info_prod">
                        <a href="vista_cooler_cli.jsp?idprod=<%=idprod2%>">
                            <div class="divimg_prod"> 
            ...
            <%  }  
                    String strQry3 = "select img_prod,nom_prod,forma_mobo,platf_mobo,chipset_mobo,maxram_mobo,producto.prec_prod,producto.id_prod from mobo "
                    ...
                    rs3.next();
                    idprod3 = Integer.parseInt(rs3.getString(8));
            %>
                    <div class="info_prod">
                        <a href="vista_mobo_cli.jsp?idprod=<%=idprod3%>">
                            <div class="divimg_prod"> 
            ...
            <%    
                    String strQry4 = "select img_prod,nom_prod,memoria_gpu,tipomem_gpu,fboost,producto.prec_prod,producto.id_prod from tar_grafica "
                    ...
                    rs4.next();
                    idprod4 = Integer.parseInt(rs4.getString(7));
            %>
                    <div class="info_prod">
                        <a href="vista_gpu_cli.jsp?idprod=<%=idprod4%>">
                            <div class="divimg_prod"> 
            ...
            <%    
                    String strQry5 = "select img_prod,nom_prod,tam_ram,vel_ram,tipo_ram,producto.prec_prod,select_ram,producto.id_prod  from ram "
                    ...
                    rs5.next();
                    idprod5 = Integer.parseInt(rs5.getString(8));
            %>
                    <div class="info_prod">
                        <a href="vista_ram_cli.jsp?idprod=<%=idprod5%>">
                            <div class="divimg_prod"> 
            ...
            <%    
                    String strQry6 = "select img_prod,nom_prod,cap_hdd,vel_hdd,interf_hdd,producto.prec_prod,producto.id_prod from hdd "
                    ...
                    rs6.next();
                    idprod6 = Integer.parseInt(rs6.getString(7));
            %>
                    <div class="info_prod">
                        <a href="vista_hdd_cli.jsp?idprod=<%=idprod6%>">
                            <div class="divimg_prod"> 
            ...
            <%    
                    String strQry7 = "select img_prod,nom_prod,cap_ssd,interf_ssd,vlec_ssd,vesc_ssd,producto.prec_prod,producto.id_prod from ssd "
                    ...
                    rs7.next();
                    idprod7 = Integer.parseInt(rs7.getString(8));
            %>
                    <div class="info_prod">
                        <a href="vista_ssd_cli.jsp?idprod=<%=idprod7%>">
                            <div class="divimg_prod"> 
            ...
            <%    
                    String strQry8 = "select img_prod,nom_prod,potencia_psu,plus80_psu,forma_psu,producto.prec_prod,producto.id_prod from fuentepoder "
                    ...
                    rs8.next();
                    idprod8 = Integer.parseInt(rs8.getString(7));
            %>
                    <div class="info_prod">
                        <a href="vista_psu_cli.jsp?idprod=<%=idprod8%>">
                            <div class="divimg_prod"> 
            ...
            <%    
                    String strQry9 = "select img_prod,nom_prod,forma_case,mbocomp_case,producto.prec_prod,producto.id_prod from gabinete "
                    ...
                    rs9.next();
                    idprod9 = Integer.parseInt(rs9.getString(6));
            %>
                    <div class="info_prod">
                        <a href="vista_case_cli.jsp?idprod=<%=idprod9%>">
                            <div class="divimg_prod"> 
            ...
            <div class="botonesfinales">
                <div class="centrarbtns">
                    <a href="mis_ensamblajes.jsp">
                        <input type="button" class="btnfinales" value="Regresar">
                    </a>
                </div>
            </div>
        </div>
