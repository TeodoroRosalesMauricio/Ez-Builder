<%-- 
    Document   : busqueda_cpu
    Created on : 22 nov. 2021, 10:04:25
    Author     : Mauricio
--%>
...
<html>
    ...
    <body>
        ...
        <!-- División que contendrá los filtros -->     
        ...
        <div class="listado_prod">
            <%
                ...
                Base bd = new Base();
                                try {
                    bd.conectar();
                    String strQry = "select producto.id_prod,nom_prod,prec_prod,img_prod,procesador.nucl_cpu,graph_cpu,frecbase_cpu,id_cpu from producto "
            ...
            <div class="tabla_prod">
                ...
                <div class="table_info">
                    <table class="tablap">
                        ...
                        <tr>
                            <td class="columna1">
                                Cantidad de núcleos: <b><%=rs.getString(5)%></b><br>
                            </td>
                        ...
                        <tr>
                            <td>
                                Gráficos integrados: <b><%=rs.getString(6)%></b><br>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                Frecuencia: <b><%=rs.getString(7)%></b>
                            </td>
                        </tr>
