<%-- 
    Document   : busqueda_ssd
    Created on : 22 nov. 2021, 10:09:59
    Author     : Mauricio
--%>
    ...
    <body>
        ...
        <div class="listado_prod">
            ...
            <%                Base bd = new Base();
                try {
                    bd.conectar();
                    String strQry = "select producto.id_prod,nom_prod,prec_prod,img_prod,ssd.cap_ssd,interf_ssd,vlec_ssd,vesc_ssd,id_ssd from producto "
            ...
            <div class="tabla_prod">
                ...
                <div class="table_info">
                    <table class="tablap">
                        ...
                        <tr>
                            <td class="columna1">
                                Almacenamiento: <b><%=rs.getString(5)%></b><br>
                            </td>
                        ...
                        <tr>
                            <td>
                                Vel. de lectura <b><%=rs.getString(7)%></b><br>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                Vel. de escritura: <b><%=rs.getString(8)%></b>
                            </td>
                        </tr>                        
                    </table>
                </div>
