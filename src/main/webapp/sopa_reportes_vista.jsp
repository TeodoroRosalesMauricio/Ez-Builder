<%-- 
    Document   : sopa_reporte_vista
    Created on : 22 abr. 2022, 15:22:04
    Author     : usuario1
--%>
        ...
        <div id="fondo_negro">
            ...
            <div id="contenido_x">
                ...
                <div id="derecho">
                    ...
                    <label class="label_rep" id="IDusuario_R"> <b><%=rs2.getString(6)%></b></label>
                ...
                <div id="boton">
                    <%
                        if (rs2.getString(3) == null) {
                    %>
                    <button id="boton_rep" disabled="true">Reporte Abierto</button>
                    <%
                    } else {
                    %>
