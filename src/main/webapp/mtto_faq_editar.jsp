...
<html>
    ...
    <body>
        ...
        <div id="fondo_negro_faqs">
            ...
            <form action="mtto_faq_editado.jsp" method="post" name="formulario1">
                ...
                <div id="contenido_x2">
                    ...
                    <div id="boton3">
                        ...
                        <a href="mtto_faq_editado.jsp?id_fak=<%=id_fak%>"> <button name="id_faq" value="<%=id_fak%>" type="submit" id="boton_rep">Editar</button> </a> <br> <br> <br> <br> 
                        <a href="mtto_edit_faq.jsp?id_fak=<%=id_fak%>">  <button id="boton_rep">Regresar</button> </a>  
