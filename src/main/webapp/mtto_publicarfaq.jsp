<%-- 
    Document   : mtto_publicarfaq
    Created on : 29 may. 2022, 15:15:17
    Author     : Mauricio
--%>
    ...
    <body>
        ...
        <% 
            ...
            try{
                ...
                String strQry1 = "select id_mtto,fec_in,fec_fi,stat_sopa from evento_sopa "
                        + "where id_ingmt = '"+id+"' and stat_sopa = 'Cerrado';";
                ResultSet rs = null;
        ...
        %>
            ...
            <div class="listamtto">
                ...
                <div class="detallesdos">
                    ...
                    <a href="mtto_faqdet.jsp?idmtto=<%=rs.getString(1)%>">
                    ...
                    <div class="eliminar">
                        ...
                        <a href="mtto_newfaq.jsp?idmtto=<%=rs.getString(1)%>">
                            <img src="iconos\publicar.png" class="ekis" alt="ekis" /> 
                        </a>
                    </div>
