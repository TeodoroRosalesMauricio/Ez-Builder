<%-- 
    Document   : mtto_sopalist
    Created on : 18 abr. 2022, 17:03:58
    Author     : Mauricio
--%>
        ...
        %>
            ...
            <div class="listamtto">
                ...
                <div class="detallesdos">
                    ...
                    <a href="mtto_sopadet.jsp?idmtto=<%=rs.getString(1)%>">
                        <input class="botonmttolist" type="button" value="Ver detalles" >
                    </a>
                        <br><br>
                        
                            <%
                                if(rs.getString(4).equals("Cerrado")){
                            %>
                    ...
                    %>
                        ...
                        <a href="A_mtto_cerrar.jsp?idmtto=<%=rs.getString(1)%>">
