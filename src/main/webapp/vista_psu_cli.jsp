...
<html>
    ...
    <body>
        <%
            ...
            try {
                bd.conectar();
                String strQry = "select producto.*,fuentepoder.* from producto "
                        + "inner join fuentepoder on producto.id_prod = fuentepoder.id_prod "
                        + "where fuentepoder.id_prod = '" + idprod + "' ;";
                ResultSet rs = null;
            ...
            <div class="derecho">
                ...
                <div class="info">
                    ...
                    <div class="caracteristicas">
                        ...
                        <div class="texto_car">
                            <!-- Características -->
                            Pyencia: <b><%=rs.getString(14)%></b><br>

                            Certificación 80 PLUS: <b><%=rs.getString(15)%></b><br>

                            Factor de forma: <b><%=rs.getString(18)%></b>
