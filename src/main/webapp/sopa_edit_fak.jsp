<%-- 
    Document   : sopa_edit_fak
    Created on : 2 jun. 2022, 09:37:56
    Author     : usuario1
--%>
        ...
        <div id="fondo_negro_faqs">
            ...
            <div id="contenido_x">
                ...
                <div id="boton">
                    ...
                    <a href="sopa_fak_editar.jsp?id_fak=<%=id_fak%>">  <button id="boton_rep">Editar</button> </a> 
                    <a href="sopa_del_faq.jsp?id_fak=<%=id_fak%>">  <button id="boton_rep">Eliminar FAQ</button> </a> 
