<%-- 
    Document   : busqueda_hdd
    Created on : 22 nov. 2021, 10:06:32
    Author     : Mauricio
--%>
    ...
    <body>
        ...
        <div class="listado_prod">
            ...
            <%                Base bd = new Base();
                try {
                    bd.conectar();
                    String strQry = "select producto.id_prod,nom_prod,prec_prod,img_prod,hdd.cap_hdd,vel_hdd,interf_hdd,id_hdd from producto "
            ...
            <div class="tabla_prod">
                ...
                <div class="table_info">
                    <table class="tablap">
                        ...
                        <tr>
                            <td>
                                Velocidad: <b><%=rs.getString(6)%></b><br>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                Interfaz: <b><%=rs.getString(7)%></b>
                            </td>
                        </tr>
                    </table>
                </div>
