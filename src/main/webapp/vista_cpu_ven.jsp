...
<html>
    ...
    <body>
        <%
            ...
            try {
                bd.conectar();
                String strQry = "select producto.*,procesador.* from producto "
            ...
            <div class="derecho">
                ...
                <div class="info">
                    ...
                    <div class="caracteristicas">
                        ...
                        <div class="texto_car">
                            <!-- Características -->
                            Cantidad de núcleos: <b><%=rs.getString(17)%></b><br>

                            Gráficos integrados: <b><%=rs.getString(19)%></b><br>

                            Frecuencia: <b><%=rs.getString(23)%></b>
