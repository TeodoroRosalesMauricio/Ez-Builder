<%-- 
    Document   : busqueda_cli
    Created on : 14 may. 2022, 19:32:26
    Author     : Mauricio
--%>
                    ...
                    <table class="tablap">
                        ...
                        <tr>
                            ...
                            <td class="botonyprecio" rowspan="3">
                                ...
                                <a href="vista_case_cli.jsp?idprod=<%=idprod%>">
                                    <input type="button" id="ver" class="carritob" value="Ver producto">
                                </a>
                            </td>
                        </tr>
                    ...
                    <table class="tablap">
                        ...
                        <tr>
                            ...
                            <td class="botonyprecio" rowspan="3">
                                ...
                                <br>
                                <input type="button" id="ver" class="carritob" value="Ver producto">
                                <a href="vista_cooler_cli.jsp?idprod=<%=idprod%>">
                                    <input type="button" id="ver" class="carritob" value="Ver producto">
                                </a>
                            </td>
                        </tr>
                    ...
                    <table class="tablap">
                        ...
                        <tr>
                            ...
                            <td class="botonyprecio" rowspan="3">
                                ...
                                <br>
                                <input type="button" id="ver" class="carritob" value="Ver producto">
                                <a href="vista_cpu_cli.jsp?idprod=<%=idprod%>">
                                    <input type="button" id="ver" class="carritob" value="Ver producto">
                                </a>
                            </td>
                        </tr>
                    ...
                    <table class="tablap">
                        ...
                        <tr>
                            ...
                            <td class="botonyprecio" rowspan="3">
                                ...
                                <br>
                                <input type="button" id="ver" class="carritob" value="Ver producto">
                                <a href="vista_gpu_cli.jsp?idprod=<%=idprod%>">
                                    <input type="button" id="ver" class="carritob" value="Ver producto">
                                </a>
                            </td>
                        </tr>
                    ...
                    <table class="tablap">
                        ...
                        <tr>
                            ...
                            <td class="botonyprecio" rowspan="3">
                                ...
                                <br>
                                <input type="button" id="ver" class="carritob" value="Ver producto">
                                <a href="vista_hdd_cli.jsp?idprod=<%=idprod%>">
                                    <input type="button" id="ver" class="carritob" value="Ver producto">
                                </a>
                            </td>
                        </tr>
                    ...
                    <table class="tablap">
                        ...
                        <tr>
                            ...
                            <td class="botonyprecio" rowspan="3">
                                ...
                                <br>
                                <input type="button" id="ver" class="carritob" value="Ver producto">
                                <a href="vista_laptop_cli.jsp?idprod=<%=idprod%>">
                                    <input type="button" id="ver" class="carritob" value="Ver producto">
                                </a>
                            </td>
                        </tr>
                    ...
                    <table class="tablap">
                        ...
                        <tr>
                            ...
                            <td class="botonyprecio" rowspan="3">
                                ...
                                <br>
                                <input type="button" id="ver" class="carritob" value="Ver producto">
                                <a href="vista_mobo_cli.jsp?idprod=<%=idprod%>">
                                    <input type="button" id="ver" class="carritob" value="Ver producto">
                                </a>
                            </td>
                        </tr>
                    ...
                    <table class="tablap">
                        ...
                        <tr>
                            ...
                            <td class="botonyprecio" rowspan="3">
                                ...
                                <br>
                                <input type="button" id="ver" class="carritob" value="Ver producto">
                                <a href="vista_pc_cli.jsp?idprod=<%=idprod%>">
                                    <input type="button" id="ver" class="carritob" value="Ver producto">
                                </a>
                            </td>
                        </tr>
                    ...
                    <table class="tablap">
                        ...
                        <tr>
                            ...
                            <td class="botonyprecio" rowspan="3">
                                ...
                                <br>
                                <input type="button" id="ver" class="carritob" value="Ver producto">
                                <a href="vista_ram_cli.jsp?idprod=<%=idprod%>">
                                    <input type="button" id="ver" class="carritob" value="Ver producto">
                                </a>
                            </td>
                        </tr>
                    ...
                    <table class="tablap">
                        ...
                        <tr>
                            ...
                            <td class="botonyprecio" rowspan="3">
                                ...
                                <br>
                                <input type="button" id="ver" class="carritob" value="Ver producto">
                                <a href="vista_ssd_cli.jsp?idprod=<%=idprod%>">
                                    <input type="button" id="ver" class="carritob" value="Ver producto">
                                </a>
                            </td>
                        </tr>
