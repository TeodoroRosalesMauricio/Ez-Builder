<%-- 
    Document   : pcb_hdd
    Created on : 27 mar. 2022, 14:35:15
    Author     : Mauricio
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            int modulos = Integer.parseInt(request.getParameter("modulos"));
            ...
            try{
                ...
                String strQry2 = "update pc_builder set select_ram = '"+modulos+"' "
        ...
        <div class="divseleccion">
            ...
            <%
                ...
                try {
                    bd.conectar();
                    String strQry = "select id_hdd,img_prod,nom_prod,cap_hdd,vel_hdd,interf_hdd,prec_prod from producto "
                            + "inner join hdd on producto.id_prod = hdd.id_prod order by prec_prod asc;";
                    ResultSet rs = null;
                    ...
                    while (rs.next()) {
                        idhdd = Integer.parseInt(rs.getString(1));
            %>
                    ...
                    <div class="info_prod">
                        ...
                        <div class="detalles">
                            ...
                            Velocidad: <b><%=rs.getString(5)%></b><br> 
                            Interfaz: <b><%=rs.getString(6)%></b><br> 
                        </div>
                        <div class="presio">
                            <br>
                            Precio:
                            ...
                            <a href="pcb_ssd.jsp?idhdd=<%=idhdd%>">
