...
<html>
    ...
    <body>
        <%
            ...
            try {
                bd.conectar();
                String strQry = "select producto.*,cooler.* from producto "
            ...
            <div class="derecho">
                ...
                <div class="info">
                    ...
                    <div class="caracteristicas">
                        ...
                        <div class="texto_car">
                            <!-- Características -->
                            Nivel de ruido: <b><%=rs.getString(22)%></b><br>

                            Sockets compatibles: <b><%=rs.getString(15)%></b><br>

                            Numero de ventiladores: <b><%=rs.getString(17)%></b>
            ...
            <div class="abajo">
                ...
                <div class="tabla">
                    ...
                    <table class="tablat">
                        ...
                        <tr class="fila1">
                            <td>&nbsp;
                                Numero de ventiladores del disipador:
                            </td>
                            <td>
                                <%=rs.getString(17)%>
                            </td>
                        ...
                        <tr class="fila2">
                            <td>&nbsp;
                                Tipo de conector del disipador:
                            </td>
                            <td>
                                <%=rs.getString(18)%>
                            </td>
                        ...
                        <tr class="fila1">
                            <td>&nbsp;
                                Numero de RPM del ventilador del disipador:
                            </td>
                            <td>
                                <%=rs.getString(19)%>
                            </td>
                        ...
                        <tr class="fila1">
                            <td>&nbsp;
                                Consumo energético del disipador:
                            </td>
                            <td>
                                <%=rs.getString(21)%>
                            </td>
