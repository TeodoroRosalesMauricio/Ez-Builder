<%-- 
    Document   : pcb_ram
    Created on : 27 mar. 2022, 14:34:58
    Author     : Mauricio
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            int idgpu = Integer.parseInt(request.getParameter("idgpu"));
            ...
            try{
                ...
                String strQry2 = "update pc_builder set id_gpu = '"+idgpu+"' "
        ...
        <div class="divseleccion">
            ...
            <%
                ...
                try {
                    bd.conectar();
                    String strQry = "select id_ram,img_prod,nom_prod,tam_ram,vel_ram,tipo_ram,prec_prod from producto "
                            + "inner join ram on producto.id_prod = ram.id_prod order by prec_prod asc;";
                    ResultSet rs = null;
                    ...
                    while (rs.next()) {
                        idram = Integer.parseInt(rs.getString(1));
            %>
                    ...
                    <div class="info_prod">
                        ...
                        <div class="presio">
                            ...
                            <a href="pcb_modram.jsp?idram=<%=idram%>">
