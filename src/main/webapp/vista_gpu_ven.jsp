...
<html>
    ...
    <body>
        ...
        <%
            ...
            try {
                bd.conectar();
                String strQry = "select producto.*,tar_grafica.* from producto "
                        + "inner join tar_grafica on producto.id_prod = tar_grafica.id_prod "
                        + "where tar_grafica.id_prod = '" + idprod + "' ;";
                ResultSet rs = null;
            ...
            <div class="derecho">
                ...
                <div class="info">
                    ...
                    <div class="caracteristicas">
                        ...
                        <div class="texto_car">
                            Memoria: <b><%=rs.getString(18)%></b><br>

                            Tipo de memoria: <b><%=rs.getString(19)%></b><br>

                            Frecuencia máxima: <b><%=rs.getString(17)%></b>
                    ...
                    <div class="botonc">
                        <a href="A_carrito.jsp?idprod=<%=idprod%>">
                            <input  disabled="true" type="button" class="carritob" value="Añadir al carrito">  
                        </a>                    
                    </div>
                </div>
            </div>
