<%-- 
    Document   : sopa_eventos_vista
    Created on : 22 abr. 2022, 15:56:24
    Author     : usuario1
--%>
...
<html>
    ...
    <body>
        ...
        <div id="banner_x">
            ...
            <img src="iconos\ver.png" alt="Información de apoyo" id="img_banner_rep"/>  

            <label id="txt_banner_rep">Evento No. <%=rs2.getString(1)%> </label>
        ...
        <div id="fondo_negro">
            ...
            <div id="contenido_x">
                ...
                %>
                <label class="label_rep" id="fecha_f">Fecha de cierre: &nbsp; <b><%=rs.getString(3)%></b></label><br>
                <%
                    }
                %> 
                <div id="izquierdo">
                    ...
                    <label class="label_rep" id="ing_sopa_L">Ing. de Mtto asignado: </label> 
                    <label class="label_rep" id="IDing_sopa_L">ID de Ing. de <br> Mtto asignado:</label>
                </div>

                <div id="derecho">
                    <label class="label_rep" id="usuario_R"><b><%=rs2.getString(10)%></b></label>
                    <label class="label_rep" id="IDusuario_R"> <b><%=rs2.getString(9)%></b></label>
                    <textarea class="label_rep" id="descripcion_E2" readonly maxlength="1500"><%=rs2.getString(4)%></textarea>
                    <label class="label_rep" id="ing_sopa_R"><b><%=rs2.getString(17)%></b></label>
                    <label class="label_rep" id="IDing_sopa_R"> <b><%=rs2.getString(16)%></b></label>
                </div>
                ...
                <div id="boton">
                    <%
                        if (rs2.getString(3) == null) {
                    %>
                    <a href="sopa_X.jsp?id_mtto=<%=id_mtto%>">  <button id="boton_rep">Cerrar Evento</button> </a> 
                    <%
                    } else {
                    %>
                    <button id="boton_rep" disabled="true">Evento Cerrado</button>
                    <%
                        }
                    %> 
                </div>
