...
<html>
    ...
    <body>
        <%
            ...
            try {
                bd.conectar();
                String strQry = "select producto.*,laptop.* from producto "
            ...
            <div class="derecho">
                ...
                <div class="info">
                    ...
                    <div class="caracteristicas">
                        ...
                        <div class="texto_car">
                            <!-- Características -->
                            Procesador: <b><%=rs.getString(14)%></b><br>

                            Memoria RAM: <b><%=rs.getString(15)%></b><br>

                            Almacenamiento: <b><%=rs.getString(17)%></b>
