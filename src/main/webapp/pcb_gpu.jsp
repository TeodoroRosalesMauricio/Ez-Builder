<%-- 
    Document   : pcb_gpu
    Created on : 27 mar. 2022, 14:34:38
    Author     : Mauricio
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            int idmobo = Integer.parseInt(request.getParameter("idmobo"));
            ...
            try{
                ...
                String strQry2 = "update pc_builder set id_mobo = '"+idmobo+"' "
        ...
        <div class="divseleccion">
            <div class="seleccionar">
                ...
                <div class="instruccion">
                    <div class="imginstruccion">
                        <img src="iconos\gpu3.png" alt="gpu" />
                    </div>
                    <div class="instruccionletras">       
                            5. Elige una tarjeta gráfica             
                    </div>
                </div>
            ...
            <%
                ...
                try {
                    bd.conectar();
                    String strQry = "select id_gpu,img_prod,nom_prod,memoria_gpu,tipomem_gpu,fboost,prec_prod from producto "
                            + "inner join tar_grafica on producto.id_prod = tar_grafica.id_prod order by prec_prod asc;";
                    ResultSet rs = null;
                    ...
                    while (rs.next()) {
                        idgpu = Integer.parseInt(rs.getString(1));
            %>
                    ...
                    <div class="info_prod">
                        ...
                        <div class="detalles">
                            ...
                            <br>
                            Memoria: <b><%=rs.getString(4)%></b><br>
                            Tipo de memoria: <b><%=rs.getString(5)%></b><br> 
                            Frecuencia máxima: <b><%=rs.getString(6)%></b><br> 
                        </div>
                        <div class="presio">
                            <br>
                            Precio:
                            ...
                            <a href="pcb_ram.jsp?idgpu=<%=idgpu%>">
